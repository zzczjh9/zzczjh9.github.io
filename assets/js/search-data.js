...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Research projects and industry experience in robotics and AI.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-adaptive-navigation-controller-with-td3",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/zecheng-zhu", "_blank");
        },
      },{
        id: 'social-inspire',
        title: 'Inspire HEP',
